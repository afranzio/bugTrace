        ...
        <div className="bottom-0 w-100 mt-16 border-t border-gray-100 pt-8">
            <footer>
                <div className="container justify-center text-center self-center mx-auto px-10 w-fit">
                    ...
                    <div className="mt-5">
                        Made with ❤️ by {" "}
                        <Link href="https://afranzio.github.io/" target="_blank" className='font-mono font-bold border-b border-gray-100'>
                            Afranzio
                        </Link>
                    </div>
                    <div className="mt-6 flex justify-center gap-4 lg:justify-center">
                        <a
                            ...
                            href="https://www.facebook.com/mani.afranzio"
                            target="_blank"
                            rel="noreferrer"
                        >
                        ...
                        <a
                            className="text-white-700 transition hover:text-white-700/75"
                            href="https://www.instagram.com/afranzio/"
                            target="_blank"
                            rel="noreferrer"
                        >
                        ...
                        <a
                            className="text-white-700 transition hover:text-white-700/75"
                            href="https://twitter.com/afranzio"
                            target="_blank"
                            rel="noreferrer"
                        >
